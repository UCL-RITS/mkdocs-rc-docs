...
If you have applied for a [shared space/hosted dataset](Additional_Resource_Requests.md#request-hosting-of-shared-datasets) 
on the cluster, there are several ways to manage access to that data.
